...
class Node {
    ...
    *_getCompilerDescendantsOfKindIterator(kind) {
    ...
    static isOverrideableNode(node) {
        return (node === null || node === void 0 ? void 0 : node.getKind()) === SyntaxKind.MethodDeclaration;
    }
