...
class Node {
    ...
    *_getCompilerDescendantsOfKindIterator(kind) {
    ...
    static isJsxNamespacedName(node) {
        return (node === null || node === void 0 ? void 0 : node.getKind()) === SyntaxKind.JsxNamespacedName;
    }
...
class JsxNamespacedName extends NamedNode(Node) {
    getNamespaceNode() {
