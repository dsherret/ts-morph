...
export declare class ImportClause extends ImportClauseBase<ts.ImportClause> {
     ...
     */
    getNamedBindingsOrThrow(): NamedImports | NamespaceImport;
    /**
