...
const createJsxSelfClosingElementBase = <T extends typeof PrimaryExpression>(ctor: T) => JsxAttributedNode(JsxTagNamedNode(ctor));
export const JsxSelfClosingElementBase = createJsxSelfClosingElementBase(PrimaryExpression);
