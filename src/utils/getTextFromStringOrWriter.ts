...
export function getTextFromStringOrWriter(writer: CodeBlockWriter, textOrWriterFunction: string | WriterFunction | (string | WriterFunction)[]) {
...
export function printTextFromStringOrWriter(writer: CodeBlockWriter, textOrWriterFunction: string | WriterFunction | (string | WriterFunction)[]) {
