...
describe(nameof(LanguageService), () => {
    ...
    describe(nameof<LanguageService>(l => l.removeUnusedDeclarations), () => {
        ...
        describe(`${nameof<LanguageService>(l => l.removeUnusedDeclarations)} parameters and type parameters`, () => {
            ...
            it("should remove unused spread parameters", () => {
                test(`
                    export function f(a: number, ...args: any[]) {
                        return a*a
                    }
                `, `
