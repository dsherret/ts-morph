...
describe(nameof(tsInternal), () => {
    describe(nameof(tsInternal.getEmitModuleResolutionKind), () => {
        function doTest(
moduleResolution: ModuleResolutionKind | undefined, module: ModuleKind | undefined, target: ScriptTarget | undefined,
            expectedKind: ModuleResolutionKind)
        {
            ...
            it(`should have the expected result for ${moduleResolutionText}, ${moduleText}, and ${scriptTargetText}`, () => {
                ...
                expect(ModuleResolutionKind[tsInternal.getEmitModuleResolutionKind(compilerOptions)]).to.equal(ModuleResolutionKind[expectedKind]);
            });
        }
