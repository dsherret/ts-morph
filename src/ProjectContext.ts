...
import { LanguageService, QuoteKind, TypeChecker, SourceFile, Diagnostic, CompilerHostFactory } from "./compiler";
...
export class ProjectContext {
    ...
    constructor(project: Project | undefined, fileSystemWrapper: FileSystemWrapper, compilerOptions: CompilerOptions, { compilerHostFactory, ...opts}: ProjectContextOptions) {
        ...
        this._languageService = opts.createLanguageService ? new LanguageService(this, { compilerHostFactory }) : undefined;
