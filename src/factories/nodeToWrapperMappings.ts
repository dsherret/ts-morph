...
export const nodeToWrapperMappings: { [key: number]: any } = {
    ...
    [ts.SyntaxKind.JsxAttribute]: compiler.JsxAttribute,
    [ts.SyntaxKind.JsxClosingElement]: compiler.JsxClosingElement,
    [ts.SyntaxKind.JsxClosingFragment]: compiler.JsxClosingFragment,
    [ts.SyntaxKind.JsxElement]: compiler.JsxElement,
    [ts.SyntaxKind.JsxExpression]: compiler.JsxExpression,
    [ts.SyntaxKind.JsxFragment]: compiler.JsxFragment,
    [ts.SyntaxKind.JsxOpeningElement]: compiler.JsxOpeningElement,
    [ts.SyntaxKind.JsxOpeningFragment]: compiler.JsxOpeningFragment,
    [ts.SyntaxKind.JsxSelfClosingElement]: compiler.JsxSelfClosingElement,
    [ts.SyntaxKind.JsxSpreadAttribute]: compiler.JsxSpreadAttribute,
    [ts.SyntaxKind.JsxText]: compiler.JsxText,
