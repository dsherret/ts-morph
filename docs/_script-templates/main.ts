import { CallExpression, CallLikeExpression, CallSignatureDeclaration, ClassDeclaration, ClassDeclarationStructure, ConstructSignatureDeclaration,
    ...
    MethodSignature, ModuleDeclaration, ModuleDeclarationKind, Node, NumericLiteral, ObjectLiteralExpression, ParameterDeclaration, Program, Project,
...
let project: Project, node: Node, classDeclaration: ClassDeclaration, functionDeclaration: FunctionDeclaration, sourceFile: SourceFile,
    ...
    parameter: ParameterDeclaration, type: Type, symbol: Symbol, signature: Signature, moduleDeclaration: ModuleDeclaration, directory: Directory,
