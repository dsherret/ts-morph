...
| H8  | **Lib files shipped by ts-morph — GONE**                                    | —                                                                                                                                                                                                                                                                                                                                                                                                                                                                 | Removed: the compiler reads its own copies out of the wasm module, and `packages/common`'s bundle fell from 3.70 MiB to 0.93 MiB (§2.3)                                                                                                                                                                                                                               | —                                                                                                                                               |
