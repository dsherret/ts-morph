...
const isTracableNode = (node: unknown): node is TracableNode => typeof node === "object" && node !== null && ("getSourceFile" in node) && ("getPos" in node);
