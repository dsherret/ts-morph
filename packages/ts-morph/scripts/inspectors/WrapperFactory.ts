...
export class WrapperFactory {
  private readonly wrappedNodeCache = new Map<tsMorph.ClassDeclaration, WrappedNode>();
  private readonly structureNodeCache = new Map<tsMorph.InterfaceDeclaration, Structure>();
  private readonly mixinNodeCache = new Map<tsMorph.Node, Mixin>();
  private readonly tsNodeCache = new Map<tsMorph.InterfaceDeclaration | tsMorph.ClassDeclaration, TsNode>();
  private readonly tsNodePropertyCache = new Map<tsMorph.PropertySignature | tsMorph.PropertyDeclaration, TsNodeProperty>();
