...
export class DocumentSpan<TCompilerObject extends ts.DocumentSpan = ts.DocumentSpan> {
    ...
    constructor(context: ProjectContext, compilerObject: TCompilerObject) {
        ...
        this._sourceFile = this._context.compilerFactory.getSourceFileFromCacheFromFilePath(context.fileSystemWrapper.getStandardizedAbsolutePath(this.compilerObject.fileName))!;
