...
describe("TypePredicateNode", () => {
    ...
    describe(nameof.property<TypePredicateNode>("getParameterNameNode"), () => {
        it("should get", () => {
            expect(getTypePredicateNode("function test(asdf): asdf is string {}").getParameterNameNode().getText(), "asdf");
        });
    });

    describe(nameof.property<TypePredicateNode>("getTypeNode"), () => {
    ...
    describe(nameof.property<TypePredicateNode>("getTypeNodeOrThrow"), () => {
        function doTest(text: string, expectedText: string | undefined) {
    ...
    describe(nameof.property<TypePredicateNode>("hasAssertsModifier"), () => {
    ...
    describe(nameof.property<TypePredicateNode>("getAssertsModifier"), () => {
        function doTest(text: string, expectedValue: boolean) {
    ...
    describe(nameof.property<TypePredicateNode>("getAssertsModifierOrThrow"), () => {
        function doTest(text: string, expectedValue: boolean) {
            const typePredicate = getTypePredicateNode(text);
            if (expectedValue)
