...
describe("QuestionDotTokenableNode", () => {
    ...
    describe(nameof.property<QuestionDotTokenableNode>("hasQuestionDotToken"), () => {
    ...
    describe(nameof.property<QuestionDotTokenableNode>("getQuestionDotTokenNode"), () => {
        it("should get it", () => {
    ...
    describe(nameof.property<QuestionDotTokenableNode>("getQuestionDotTokenNodeOrThrow"), () => {
        it("should get it", () => {
            const { expr: firstMember } = getInfoWithFirstExpr("call?.()");
    ...
    describe(nameof.property<QuestionDotTokenableNode>("setHasQuestionDotToken"), () => {
